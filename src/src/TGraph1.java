...
public class TGraph1 extends Graph {
    ...
    public TGraph1(int N, int M, int T) {
        super(N, M, T);
    ...
    private int bfs() {
        ...
        for (TEdge edge = prev[T][sink]; edge != null; edge = prev[edge.startT][edge.startN]) edge.add(bottleNeck);
